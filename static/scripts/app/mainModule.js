(function() {
    ...
    var routeConfig = function($routeProvider) {
        ...
        $routeProvider
            ...
            .when("/catalogue", {
                templateUrl: '/static/view_templates/catalogue.html',
    ...
    var SampleFactory = function($resource) {
    ...
    var catalogueController = function(PageFactory, ItemFactory, $scope) {
        PageFactory.get({ id: 3}, function(data) {
            $scope.pageHeader = data;
        });
        ...
        SampleFactory.query(function(data) {
            $scope.pageItems = data;
        });
    };
